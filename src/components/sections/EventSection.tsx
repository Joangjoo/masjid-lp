...
import { featuredEvent } from '../../data/landingData';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#C49B5E]/15 text-[#C49B5E] font-bold text-xs md:text-sm px-4 py-1.5 rounded-full mb-6">
              ...
              <span>{featuredEvent.dateTag}</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-[#13294B] font-medium text-sm md:text-base mb-8">
              ...
              <span>Pembicara: <strong className="text-[#13294B]">{featuredEvent.speaker}</strong></span>
            </div>
          ...
          >
            ...
            <p className="text-white/80 text-base md:text-lg mb-8 leading-relaxed">
              Masjid Al-Hikmah senantiasa menghadirkan berbagai agenda keagamaan, sosial, dan edukasi untuk mempererat ukhuwah islamiyah dan memakmurkan masjid bersama masyarakat.
            </p>
