...
export const featuredTestimonials: TestimonialItem[] = [
  {
    id: 'ft1',
    quote: 'Sejak pindah ke sini, Masjid Al-Hikmah menjadi ruang belajar, bersosialisasi, dan tempat anak-anak saya tumbuh dalam nilai-nilai Islam. Rasanya seperti memiliki keluarga baru.',
    name: 'Ibu Fatimah',
    role: 'Ketua PKK',
...
export const contactInfoCards: ContactInfoCard[] = [
  {
    id: 'ci1',
    title: 'Alamat',
    value: 'Jl. Masjid Al-Hikmah No. 15',
