...
import { teamMembers as fallbackTeam } from '../../data/landingData';
            ...
            >
              <Card className="h-full flex flex-col items-center text-center p-8 border border-gray-100">
                <div className="w-24 h-24 rounded-full overflow-hidden mb-6 border-2 border-[#C49B5E] shadow-md">
                  <img
                    src={member.image_url || member.imageUrl || 'https://i.pinimg.com/1200x/35/fb/ab/35fbab9dc42fd1fe4fd5777617508981.jpg'}
                    alt={member.name}
